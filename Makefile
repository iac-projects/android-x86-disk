docker: Dockerfile grub.cfg
	sudo docker build . -t quay.io/quamotion/android-x86-disk:7.1-r2-4.20rc4
	sudo docker image ls --format "{{.ID}}" quay.io/quamotion/android-x86-disk:7.1-r2-4.20rc4 > docker
