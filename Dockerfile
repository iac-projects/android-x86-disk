...
FROM quay.io/kubedroid/android-x86-kernel:kernel-4.13 AS kernel-4.13
FROM quay.io/kubedroid/android-x86-kernel:kernel-4.14 AS kernel-4.14
FROM quay.io/kubedroid/android-x86-kernel:kernel-4.15 AS kernel-4.15
FROM quay.io/kubedroid/android-x86-kernel:kernel-4.16 AS kernel-4.16
FROM quay.io/kubedroid/android-x86-kernel:kernel-4.17 AS kernel-4.17
FROM quay.io/kubedroid/android-x86-kernel:kernel-4.18 AS kernel-4.18

FROM quay.io/kubedroid/android-x86-base:7.1-r2 AS base
