...
COPY --from=kernel-4.18 /android/kernel/vmlinuz-4.18.0-android-x86_64-kubedroid-guest .
COPY --from=kernel-4.18 /android/kernel/lib/modules/4.18.0-android-x86_64-kubedroid-guest/kernel/ system/lib/modules/4.18.0-android-x86_64-kubedroid-guest/kernel/
COPY --from=kernel-4.18 /android/kernel/lib/modules/4.18.0-android-x86_64-kubedroid-guest/modules.* system/lib/modules/4.18.0-android-x86_64-kubedroid-guest/

COPY --from=kernel-gvt-stable-4.17 /android/kernel/vmlinuz-4.17.0-android-x86_64-kubedroid-guest-gvt .
COPY --from=kernel-gvt-stable-4.17 /android/kernel/lib/modules/4.17.0-android-x86_64-kubedroid-guest-gvt/kernel/ system/lib/modules/4.17.0-android-x86_64-kubedroid-guest-gvt/kernel/
COPY --from=kernel-gvt-stable-4.17 /android/kernel/lib/modules/4.17.0-android-x86_64-kubedroid-guest-gvt/modules.* system/lib/modules/4.17.0-android-x86_64-kubedroid-guest-gvt/
